...
public class TeleOpCartesian extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            final double powerMultiplier = 1;
            
            robot.FL.setPower(v1*powerMultiplier);
            robot.FR.setPower(v2*powerMultiplier);
            robot.BL.setPower(v3*powerMultiplier);
            robot.BR.setPower(v4*powerMultiplier);
